<h3 class="h3 h3-responsive text-center mt-3"><?php echo $d=date("d-M-Y");?></h3>
<?php
...
<tr <?php if($deb =="1"){
	...
	<td>
		...
		<i id="ht" class="hidden"> <?php echo $count; ?></i>
	</td>
	<?php }?>
    <td>
...
<?php	
	...
	<tr class="mb-2"><b>Total SALES (shs)= <?php echo $t; ?></b> <b class="ml-3"> Total Debts (shs)= <?php echo -$debt_total; ?> </b></tr>
...
?>
			<tr class="mb-2"><b>Total Crates(shs)= <? echo $t; ?> </b></tr>		
					</table>
				</div>
			</div>
